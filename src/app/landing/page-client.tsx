  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-m-background relative flex h-screen flex-col items-center justify-center gap-20 overflow-hidden"
      >
        <StaggerPhraseAnim text="Full Stack Developer" delay={2} />
      ...
      {/* <BottomWidget /> */}
      <div className="bg-m-light h-screen">
        <Fade
