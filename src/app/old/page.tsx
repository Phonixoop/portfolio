  ...
  return (
    <>
      <ViewTransition enter={"slide-down"} exit={"exit-up"}>
        <div className="relative mx-auto w-full overflow-hidden p-4 sm:p-6 md:p-8">
          {" "}
              ...
              <div className="rounded-me-radius-card line_x_animation relative flex flex-col gap-20 p-6 lg:p-16">
                ...
                <StaggerContainer className="flex w-full flex-col gap-2">
                  ...
                  >
                    ...
                    automated systems. My goal is to combine creative thinking
                    and design with an analytical approach to solve problems at
                      ...
                      return (
                        <MagneticGsap>
                          <MotionEl
                            ...
                            slideFrom="left"
                            blur
                            className="bg-m-dark flex flex-row items-center justify-between gap-1 rounded-xl p-5 backdrop-blur-3xl lg:flex-col"
                          >
                            {skill.icon}
                ...
                <StaggerContainer className="flex w-full flex-wrap items-center justify-between gap-2 rounded-xl">
                  <MotionEl
                    as={Link}
                    fade="in"
                    slideFrom="left"
                    ...
                    target="blank"
                    className="bg-m-dark grow rounded-xl p-1 backdrop-blur-3xl"
                  >
                  ...
                  <MotionEl
                    ...
                    className="bg-m-dark flex grow items-center justify-center gap-2 rounded-xl px-2 py-1 backdrop-blur-3xl"
                  >
